    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Toutes les annonces</h1>
            </div>
            <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
                ...
                <a href="{{ route('admin.annonce.ajouter') }}"
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                        <div class="text-base font-semibold text-gray-900 dark:text-white">
                                            {{ Str::limit($annonce->nom, 30) }}</div>
                                        <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                            {{ $annonce->user->name }}</div>
                                    </td>
                                    <td
                                        class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white w-10">
                                        <img src="{{ Storage::url($annonce->image) }}" alt="{{ $annonce->nom }}">
                                    </td>
                                    <td
                                        class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400">
                                        {{ Str::limit($annonce->description, 35) }}
                                    </td>
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <a href="{{ route('admin.annonce.show', ['id' => $annonce->id]) }}"
                                        ...
                                        <a
                                            href="{{ route('admin.annonce.ajouter', ['id' => $annonce->id]) }}"class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                        ...
                                        <div id="deleteModal" tabindex="-1" aria-hidden="true"
                                            ...
                                            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                                ...
                                                <div
                                                    ...
                                                    <p class="mb-4 text-gray-500 dark:text-gray-300">Etes-vous sur de vouloir supprimer cette annonce?</p>
                                                    <div class="flex justify-center items-center space-x-4">
                                                        <button data-modal-toggle="deleteModal" type="button"
                                                            class="py-2 px-3 text-sm font-medium text-gray-500 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
                                                            Non, j'annule
                                                        </button>
                                                        <a href="{{ route('admin.annonce.delete', ['id' => $annonce->id]) }}">
                                                        <button type="submit"
